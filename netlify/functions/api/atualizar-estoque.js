...
module.exports = async (req, res) => {
    ...
    try {
        ...
        const errorMessage = error.response && error.response.data && error.response.data.error ? error.response.data.error.error.message : error.message; // Correção no acesso ao erro
